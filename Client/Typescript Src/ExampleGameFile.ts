            ...
            if (enemyMetadataForFrame != null) {
                if (enemyMetadataForFrame.waveNumber != waveNumber) {
                    ...
                    for (var i: number = 0; i < enemyMetadataForFrame.info.length; i++) {
						...
						var enemyInformationPopup: Phaser.Sprite = new Phaser.Sprite(apg.g, enemyInformationArea.x + 20, i * 100 + enemyInformationArea.y + 20, 'assets/'+ enemyMetadataForFrame.info[i].enemyName +'Popup.png');
